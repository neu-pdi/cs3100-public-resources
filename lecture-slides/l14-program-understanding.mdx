...
<p style={{fontSize: '0.85em', marginTop: '1em'}}>
Two test cases fail. Observations:
</p>

<ul style={{fontSize: '0.8em'}}>
  <li>Double quotes in content are being <strong>stripped</strong></li>
  <li>Tags after a leading quote are <strong>not removed</strong></li>
</ul>
...
→ **Transition:** Let's talk about the costs and benefits of this approach...
</aside>

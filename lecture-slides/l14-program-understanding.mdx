...
{/* VISUAL OPTION B: Mountain Climbing */}
{/*
<Img
  src="/img/lectures/web/l14-kernighan-mountain.png"
  alt="Developer who built a steep mountain of clever code now struggling to climb it for debugging"
  prompt="Visual concept for Kernighan quote: 'Debugging is twice as hard as writing code'

THE METAPHOR: Building vs Climbing Your Own Mountain

SCENE: A dramatic split showing the same mountain from two perspectives.

BOTTOM HALF - 'WRITING CODE' (looking up):
- A developer at the base, happily stacking blocks/bricks upward
- Each block is labeled with clever code concepts: 'nested ternary', 'one-liner', 'regex magic', 'implicit conversion'
- The developer is smiling, feeling accomplished
- They're building the mountain higher and higher
- Caption: 'Building the mountain feels easy when you're at the bottom'
- Arrows pointing UP showing the direction of building

TOP HALF - 'DEBUGGING' (looking down):
- The SAME developer, now tiny, exhausted, clinging to the steep mountainside
- They're trying to climb UP what they built, but it's impossibly steep
- The clever code blocks are now obstacles: slippery, crumbling, no handholds
- Vertigo lines showing how high and dangerous it is
- A sign at the top says 'THE BUG' with a little bug icon
- Caption: 'But you have to climb it to find the bug'
- The developer thinking: 'Why did I build it so steep?!'

KEY VISUAL ELEMENTS:
- The mountain should look MUCH harder to climb than it was to build
- The steepness represents code complexity
- Each 'clever' block that was easy to place is now a treacherous foothold
- The bug at the top is tiny but the path to reach it is brutal

BOTTOM INSIGHT:
'Every clever trick you add while writing makes the climb harder when debugging.'
'Build mountains you can actually climb.'

VISUAL STYLE:
- Side-view showing the full mountain
- Dramatic perspective emphasizing height and steepness
- The contrast between the easy building and hard climbing should be visceral
- Could be pixel art adventure game style or illustrated style

The message: You're building your own future obstacle course."
/>
*/}

...
**Where you are now:**
- Individual assignments, ~500-1000 lines of code
- You wrote most of it yourself
- Structure fits in your head

**Where you're heading:**
- Group project with teammates' code
- Open-source libraries with thousands of files
- Unfamiliar codebases you need to modify or debug
...
<aside className="notes">
**The reality check:**
- Assignment 4 is coming—more complex model with library, cookbooks
- Group project in March—you'll inherit teammates' code
- Future jobs—you'll rarely start from scratch
...
**Today's promise:** We're going to learn the fundamental skills for tackling unfamiliar code. We'll practice at small scale so you're ready when the big codebases arrive.

→ **Transition:** These are learnable skills...
</aside>
...
1. **Form a hypothesis:** "I think this class handles user authentication"
2. **Test it:** Look at method names, read key functions, trace a call
3. **Refine:** "Actually, it only handles password hashing—auth is elsewhere"
...
- When you recognize "this is a Strategy pattern," you instantly know how it works
...
Today we'll practice these techniques at small scale—so they're second nature when you hit big codebases.
</p>

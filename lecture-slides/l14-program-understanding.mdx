...
## Program Understanding Is a Skill
...
**Two core questions:**
1. **Control flow:** What *path* does execution take?
2. **Data flow:** What *values* exist at each point?
...
Today we'll learn these techniques at a small scale—so they become second nature when you need them on large codebases.
</p>

<aside className="notes">
**The mindset shift:**
- Some students think "I'm just not good at reading code"
- Wrong! It's a skill like any other
- The techniques we'll learn today work at ANY scale

**Connection to L5 (Readability):**
- Good naming and structure make understanding easier
- But you still need techniques for when code ISN'T well-written
- (And let's be honest—you'll encounter plenty of that)

**Connection to L13 (AI Assistants):**
- AI can help explain code—but YOU need to verify

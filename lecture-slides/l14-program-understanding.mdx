...
<Img
  ...
  alt="Transformation from scattered chaotic notes to organized clear patterns"
  prompt="A simple before/after transformation graphic with NO text, titles, or captions.

LEFT SIDE - CHAOS:
A messy jumble of scattered sticky notes, random arrows pointing nowhere, question marks, crumpled paper, tangled strings on a corkboard. Stressed, disorganized energy. Muted/grey tones.

RIGHT SIDE - CLARITY:
Clean organized grid/structure, neat rows and columns (but NO actual text in them - just clean boxes), arrows pointing to clear connections, a lightbulb moment. Calm, organized energy. Bright/clear tones.

CENTER:
A large arrow pointing from left to right showing the transformation.

VISUAL STYLE:
- No text, labels, titles, or captions anywhere
- Left: chaotic, messy, grey/stressed colors
- Right: structured, organized, bright/confident colors
- Simple, clean illustration style
- The contrast between chaos and order tells the whole story"
/>

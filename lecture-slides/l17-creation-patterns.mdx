...
<ul style={{fontSize: '0.7em'}}>
  ...
  <li><code>from()</code> — type conversion: <code>Date.from(instant)</code>, <code>Instant.from(temporal)</code></li>
...
<p style={{fontSize: '0.85em', marginTop: '0.5em'}}>
Field injection (using <code>@Autowired</code> annotations) optimizes for <strong>writing</strong> code. But code is written once and read/maintained many times:
</p>

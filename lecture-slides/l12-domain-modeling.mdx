...
<p style={{fontSize: '0.85em', marginTop: '1em'}}>
These exercises are <strong>not required during lecture time</strong>. They are provided for:
</p>

<ul style={{fontSize: '0.8em'}}>
  <li>Lab activities and discussion</li>
  <li>Homework practice</li>
  <li>Self-study and review</li>
</ul>

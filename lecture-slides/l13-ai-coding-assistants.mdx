---
sidebar_position: 13
title: "LS13: AI Coding Assistants"
...
<ul style={{fontSize: '0.8em'}}>
  <li><strong>Lab 6 (Monday):</strong> Hands-on practice + surveys that will shape future lectures and workshops</li>
  <li><strong>Tuesday evening:</strong> <a href="https://www.khoury.northeastern.edu/event/ai-at-khoury-college-an-undergraduate-student-and-faculty-conversation/">Panel discussion with Prof. Bell and Associate Dean Christo Wilson on AI in the curriculum</a> (6:00-7:30pm in WVH 102, organized by UG Advisory Committee, registration required)</li>

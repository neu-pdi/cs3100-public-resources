...
- Arc 4: Forming Your Team (~6 min) — Tuckman stages, team contracts
...
**Narrative spine:** Every team project fails for the same reasons—not technical skill, but collaboration. This lecture gives students the principles (HRT), practices (GitHub workflows), and agreements (team contracts) that separate teams that ship from teams that implode.

**Important timing context:**
- **Teams are formed:** Students already know their teams
- **Team contract is live:** First deliverable, due soon
...
- **Team contract is live:** Your first team deliverable, due soon
...
<ul style={{fontSize: '0.85em'}}>
  ...
  <li><strong>The agreements</strong> that prevent conflicts (team contracts, shared expectations)</li>
</ul>
...
- **Agreements** = team contracts, explicit expectations
...
**For this class:** Your team contract is <strong>live now</strong>—it's your first team deliverable. We'll cover the details at the end of this lecture.
...
**Your first deliverable is live:** The team contract is graded and sets the foundation for everything. Teams that skip this step or do it carelessly struggle later. Take it seriously—it's due soon.

> **Transition:** Team contracts establish shared expectations. But even with good agreements, conflicts happen. Here's how to handle them...
</aside>
...
**Your first deliverable:** The team contract is live. Apply these principles *today* with your new team.

</div>

<aside className="notes">
**Callback to the opening:** We started with the question of what separates teams that ship from teams that implode. The answer: principles (HRT), practices (GitHub workflows), and agreements (team contracts).

**Looking ahead:**
- **Now:** Team contract is your first deliverable — apply everything from today immediately
- **After spring break:** Group project coding begins — you'll build on the foundation you establish now

**For your group projects:**
- Establish team contracts early—it's your first deliverable
...
## Your First Team Deliverable: The Team Contract

<p style={{fontSize: '0.9em', fontWeight: 'bold', color: '#9370DB'}}>
Your team contract is live now. This is not a formality—it's the foundation for everything that follows.
</p>
...
<aside className="notes">
**This is graded.** Take it seriously. Teams that rush through the contract often struggle later when conflicts arise and they have no shared expectations to fall back on.
...
- ✓ "We'll post daily standups in Discord by 9 PM"
...
<aside className="notes">
**Emphasize:** The contract is a *living document*. You can update it as you learn what works. But having an initial agreement is critical.
...
**The test:** If a conflict arises in week 3, can you point to a specific line in your contract that addresses it?
</aside>

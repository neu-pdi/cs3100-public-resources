...
<ul style={{fontSize: '0.85em', marginTop: '1em'}}>
  ...
  <li><strong>Cohesion:</strong> How much a module is related to its <em>own</em> responsibilities</li>
</ul>
...
<Img
  src="/img/lectures/web/l7-junk-drawer.webp"
...
<p style={{fontSize: '0.85em', marginTop: '0.5em', color: '#8BC34A'}}>
  ⚠ Now EmailService depends on the Submission structure.
</p>
...
## Fix Control Coupling with Separate Methods or Strategy Pattern
...
class NotificationService {
    public static void sendGradeReleaseNotifications(Assignment assignment) {
        ...
        for (Submission submission : submissions) {
            submission.sendNotification(submission.student,
                "Your grade has been released!", DeliveryType.EMAIL);
        }
    }
}
```
...
## Content Coupling: Bypassing Interfaces Breaks Encapsulation

<p style={{fontSize: '0.9em'}}>
  A module <strong>bypasses the interface</strong> and directly accesses internals.
</p>
...
<p style={{fontSize: '0.85em', marginTop: '0.5em'}}>
  But a "clever" developer bypasses this with reflection...
</p>
...
## Reflection is Content Coupling: Invisible, Fragile Dependencies

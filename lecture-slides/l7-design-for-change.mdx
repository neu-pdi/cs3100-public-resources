...
<p style={{fontSize: '0.65em', marginTop: '0.5em', color: '#888'}}>
  <em>Why "stamp"? Like the being coupled to the exact stamp on an envelope with a letter inside—you're coupled to its specific format, which might change.</em>
</p>

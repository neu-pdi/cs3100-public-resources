 ...
 * @returns the sum of the elements, or 0 if arr is empty
...
<p style={{fontSize: '0.8em', marginTop: '0.5em'}}>
  If <code>cis</code> is <code>"HELLO"</code>, then<br/>
  <code>cis.equals("hello")</code> → true,<br/> but <code>"hello".equals(cis)</code> → false!
</p>

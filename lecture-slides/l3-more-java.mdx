...
<Img
  ...
  alt="Here is a detailed prompt designed for Gemini's image generation capabilities. It structures the complex visual narrative into a cohesive retro-advertising layout.

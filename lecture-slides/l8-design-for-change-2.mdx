...
<p style={{fontSize: '0.7em'}}>
  Imagine we want a `Set` that counts how many times its `add()` method was called.:
</p>
...
classDiagram
    ...
    style Decorator fill:#2d4a5a,stroke:#4ac,stroke-width:2px,stroke-dasharray: 5 5
    ```
    </div>
    <div>
...
<p style={{fontSize: '0.6em'}}>
  Source: https://www.cs.unc.edu/~stotts/GOF/hires/pat4dfso.htm
</p>
...
<p style={{fontSize: '0.7em', marginTop: '1', fontWeight: 'bold'}}>

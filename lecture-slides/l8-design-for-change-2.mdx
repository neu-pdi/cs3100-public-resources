...
LEFT SIDE (Bad - 'Direct Dependency'): A laptop (labeled 'PawtograderSystem') with its power cord hardwired directly into a specific wall outlet labeled 'MySQL'. The cord is permanently attached with welds/solder. A thought bubble from the laptop: 'I can ONLY work with MySQL!' If you want to use a different database, you'd have to cut the cord.

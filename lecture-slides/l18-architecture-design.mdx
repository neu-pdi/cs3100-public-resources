...
## Comparing Boundaries: Where Does Intelligence Live?
...
- ⚠️ **Reliability:** Grading requires active network connection to Pawtograder API.
- ⚠️ **Complexity:** Needs OIDC auth flow to get the download URL and ensure that student code is immutably recorded before receiving access to the grader code.

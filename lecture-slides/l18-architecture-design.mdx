---
sidebar_position: 18
title: "LS18: Thinking Architecturally"
...
| **Where does business logic live?** | "Grading action" component — knows Java, Gradle, checkstyle etc. Parses, scores, normalizes | Platform — `Grader` subclasses per language |
...
<div style={{padding: '0.75em', border: '2px solid #4CAF50', borderRadius: '8px', width: '100%'}}>
...
<div style={{padding: '0.75em', border: '2px solid #FF9800', borderRadius: '8px', width: '100%'}}>
...
→ **Transition:** Before we see how these come together, let's pause for a quick poll...
</aside>
...
📊 <strong>pollev.com/jbell</strong>
</p>

<p style={{fontSize: '0.9em', textAlign: 'center', marginTop: '1em', color: '#666'}}>
Take a moment to reflect on what you've learned and predict what comes next.
</p>

<aside className="notes">
**Open Poll Everywhere and run the survey (~3-4 min)**

**Questions:**
1. **Word Cloud:** "In one word: What makes code HARD to change?"
2. **Reflection:** "Think about your most frustrating debugging experience. Which boundary problem was likely involved?"
   - Couldn't test the broken part in isolation
   - Couldn't tell which component was responsible
   - A change in one place broke something far away
   - Had to understand the whole system to fix one thing
3. **Opinion:** "What's your instinct when requirements are unclear: build flexibility or keep it simple?"
4. **Prediction:** "Based on the four heuristics, how many distinct components should Pawtograder have?"
   - 2 / 3 / 4 / 5+

**After the prediction question:** "Let's see if your intuition matches what the heuristics reveal..."

→ **Transition:** Now let's see how these heuristics converge on a structure...
</aside>

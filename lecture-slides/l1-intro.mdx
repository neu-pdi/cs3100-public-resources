---
sidebar_position: 1
title: "LS1: Course Overview and Introduction to Java"
...
## Our perspective: AI is a noisy amplifier, but can still be useful
  <Img
    ...
    alt="AI as amplifier diagram with intentional errors for students to find"
    prompt="Concept: 'The Amplifier, Not the Signal' (Self-Demonstrating Version)
...
## AI coding assistance is not permitted in weeks 1-5
  <Img
    ...
    alt="Split-panel showing bugs invisible without foundation vs visible with foundation"
    prompt="Concept: 'The Reviewer's Paradox' (Can't Review What You Can't Write)

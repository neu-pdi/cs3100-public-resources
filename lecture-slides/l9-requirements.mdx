...
<Img src="/img/web/tire-swing-oregon-experimentp44.jpg" alt="The classic tire swing cartoon showing how requirements get lost in translation: what the customer described, what was designed, what was built, and what the customer actually needed." style={{maxHeight: '450px'}} />

<p style={{fontSize: '0.75em', textAlign: 'center', fontStyle: 'italic'}}>
Versions of this image have circulated since the early 1900s. Christopher Alexander used it in "The Oregon Experiment" (1975).
</p>

<aside className="notes">
**Historical context:**
- This meme has existed for over 100 years

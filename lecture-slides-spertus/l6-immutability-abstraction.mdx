...
<PollSlide username="espertus" choices={["Learning as much as possible", "Getting a high grade", "Getting a strong letter of recommendation",
...
<PollSlide username="espertus" choices={["Give up", "Keep grinding away", "Go to office hours", "Ask a friend for help",
...
<Img
  ...
  style={{float: 'right', maxWidth: '40%', marginLeft: '1.5em', marginBottom: '1em'}}
/>
...
> "A Big Ball of Mud is a haphazardly structured, sprawling, sloppy, duct-tape-and-baling-wire, spaghetti-code jungle." — <cite>Brian Foote and Joseph Yoder</cite>
...
```
    <p style={{color: '#666', fontSize: '0.9em', marginTop: '0.5em'}}>
      The language <em>prevents</em> violations.
    </p>
  </div>
</div>
...
<ul style={{fontSize: '0.85em', marginTop: '1em'}}>
  <li><strong>Conventions don't scale</strong> — "please don't" becomes "someone did"</li>
  <li><strong>Deadlines happen</strong> — under pressure, developers take shortcuts</li>
  <li><strong>Teams change</strong> — new members don't know the unwritten rules</li>
</ul>

<p style={{fontSize: '0.9em', marginTop: '1em'}}>
  Java's enforcement tools: <code>private</code>, <code>final</code>, <code>sealed</code>, modules
</p>

<p style={{fontSize: '0.85em', marginTop: '1em', color: '#27ae60', textAlign: 'center'}}>
...
<Img src="/img/lectures/web/l6-led-traffic-lights.png"
 alt="Headline from CBC article: 'LED traffic lights trouble in winter because they don't melt snow"/>

<p>
Source: [CBC](https://www.cbc.ca/news/canada/windsor/led-traffic-lights-trouble-in-winter-because-they-don-t-melt-snow-1.3465301)
</p>

<aside className="notes">
- The XKCD cartoon is surprisingly close to a real incident.
- When incandescent bulbs in stoplights were replaced with LED lights, they became less visible,
  since they did not melt snow blocking the light.

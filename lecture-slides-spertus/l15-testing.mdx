...
<PollSlide username="espertus"
  choices={["Yes", "Haven't tried yet", "Tried, still waiting for it to go through"]}
  />
...
<PollSlide username="espertus"
  choices={["I already had it", "Last week", "Over the weekend", "Monday", "Tuesday", "Today", "I haven't requested it"]}
  />
...
<p style={{ marginTop: '2em', fontSize: '0.8em', color: '#666' }}>©2026 Jonathan Bell & Ellen Spertus, CC-BY-SA</p>
...
<Img src="/img/lectures/web/l15-code-coverage-factorial.png"
  alt="VS Code screenshot showing partial coverage of factorial with a single base-case test"
/>

<aside className="notes">
* Go over each line.
* Point out that only one direction of the branch was tested.
* Apologize to students with red-green color blindness.
...
<Img src="/img/lectures/web/l15-code-coverage-factorial2.png"
  alt="VS Code screenshot showing 100% coverage of factorial with base-case and recursive tests"
/>
...
<aside className="notes">
* Adding a test of the recursive case brought us to 100%
* Don't spoil poll on next slide about whether coverage guarantees bug-free code
...
<PollSlide
  username="espertus"
  choices={["100% line coverage", "100% branch coverage", "100% line and branch coverage", "none of the above"]}
/>
...
alt="Four-panel meme of a blue bird. Panel 1: Bird angrily yells 'Get that thing out of my face!' at a cracker labeled 'Unit Tests'. Panel 2: Bird takes a bite of the cracker with a 'chomp'. Panel 3: Empty. Panel 4: Bird has sparkly eyes and a blissful expression with bubbles around it. Caption reads 'When a unit test helps you find a bug you wouldn't have found otherwise'."
width={800}
/>
...
<aside className="notes">
I told you back in lecture 5 about the Mars Climate Orbiter, which was lost
...
<Img src="/img/lectures/web/l15-dependency-injection.png"
  alt="Tweet from patrick thomson @importantshock
...
<aside className="notes">
* Dependency injection sounds fancy
* But it's just passing values to functions
* So make sure your constructors and methods can take arguments
</aside>
...
<Img src="/img/lectures/web/l15-test-coverage-hack.png"

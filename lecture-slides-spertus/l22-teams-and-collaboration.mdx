...
<div className='fragment'>
You can look at [Pawtograder issues](https://github.com/pawtograder/platform/issues)
</div>

<aside className="notes">
> **Transition:** Once you have commits, you need a way to share them—and work in parallel without stepping on each other. That's where branches come in...
</aside>
...
<div style={{fontSize: '0.72em', marginTop: '0.3em', color: 'black'}}>
...
<p className="fragment" style={{fontSize: '0.78em', marginTop: '0.6em', color: '#9370DB', fontWeight: 'bold'}}>
...
**The silence row:** Reviewers who only comment on problems—never acknowledge good work—erode morale over time. A quick "nice refactor" costs nothing.

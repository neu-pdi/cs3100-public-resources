...
<Slide>
## Poll: What would you think of a lab on Java?

<div style={{fontSize: '0.7em'}}>
We have not had time in lecture to address common areas of confusion for Java
learners. Would you attend one? (Unlike with other polls, I will track answers.)
</div>

<PollSlide username="espertus"
  choices={[
    "I know Java well so feel no need.",
    "It would be helpful, and I would attend.",
    "Other (please enter on Q&A poll)"
  ]}
/>
...
<div style={{fontSize: '0.7em'}}>
We offer [in-person office hours and video appointments](https://northeastern.instructure.com/courses/239378). (Answers are anonymous but count toward your participation grade.)
</div>
<PollSlide username="espertus"
...
<div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5em', fontSize: '0.7em', marginTop: '0.5em'}}>
...
<p style={{fontSize: '0.7em', marginTop: '1em'}}>
...
<div style={{display: 'flex', gap: '1em', fontSize: '0.7em'}}>
<div style={{flex: 1}}>
...
<Img
  src="/img/lectures/web/l14-hypothesis-funnel.png" width={1000}
...
<p style={{fontSize: '0.75em', marginTop: '0.5em', textAlign: 'center'}}>

...
<p style={{fontSize: '0.8em', marginTop: '0.75em', backgroundColor: 'rgba(147, 112, 219, 0.15)', padding: '0.5em', borderRadius: '6px'}}>
<strong>Business logic</strong>: the rules, workflows, and decisions that define how a domain actually operates—independent of how we store or display data.
</p>
...
<QuoteSlide quote="Any fool can write code that a computer can understand. Good programmers write code that humans can understand."
 ...
 credit="Image credit: Webysther Nunes CC-BY-SA 4.0"/>
...
Book can manage its own collection.<br/>Copy must reach into Book's internal list.
</p>
...
**Transition:** Since I mentioned JSON, I should define it...
</aside>
...
**Transition:** Now let's look at a controller.
</aside>
...
## Controller Example: Escalating a Regrade Request
```mermaid
flowchart TB
...
<p style={{fontSize: '0.85em'}}>
What class should check if a student has exceeded their maximum regrade requests
for the semester?
</p>

<PollSlide
    username="espertus"
    choices={["Student", "RegradeRequest", "RegradeService", "RegradeController", "A new RegradePolicy class"]} />

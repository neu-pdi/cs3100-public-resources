...
- Sprites are 2D images used in video games, such as Frogger (shown).
- The moving game elements, such as cars and the frog, are sprites.
</aside>
...
<Img src="/img/lectures/web/l8ex-imagesprite-blocks.png"
  alt="Blocks showing ImageSprite method calls and a cute graphic of a mole"
/>

</div>
</div>
<aside className="notes">
- Ellen implemented ImageSprite before other types of sprites.
...
- The mole diagram was created by Yun Miao when she was a Mills student. She now is a Google engineer.
</aside>
...
<div style={{textAlign: 'center'}}>
  <Img src="/img/lectures/web/l8ex-imagesprite-placement.png" width={300}
    alt="Image showing (x,y) at the top-left corner of a cute mole graphic"
   />
...
<div style={{textAlign: 'center'}}>
  <Img src="/img/lectures/web/l8ex-ball-placement.png" width={300}
   alt="Image showing (x,y) at the top-left corner of a circle"
 />
  <p style={{marginTop: '.25em', fontSize: '0.7em'}}>
...
<div style={{textAlign: 'center'}}>
  <Img src="/img/lectures/web/l8ex-right-ball-placement.png" width={300}
   alt="Image showing (x,y) at the corner of a circle"/>
  <p style={{marginTop: '.25em', fontSize: '0.7em'}}>
...
* [My Most Embarrassing Mistakes as a Programmer (so far)](https://stackoverflow.blog/2019/10/29/my-most-embarrassing-mistakes-as-a-programmer-so-far/) by Ellen Spertus
* [Bumper-Sticker API Design](https://www.infoq.com/articles/API-Design-Joshua-Bloch/) by Joshua Bloch

<Img src="/img/lectures/web/l8ex-api-ipa.png"
  alt="Tweet by Wouter Witvoet @wwitvoet:
       Overheard at SFO.

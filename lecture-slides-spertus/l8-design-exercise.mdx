...
- Almost all of ImageSprite as moved to a new abstract class Sprite.
...
<div style={{textAlign: 'center'}}>
  <Img src="/img/lectures/web/l8ex-ball-placement.png" width={300} />
  <p style={{marginTop: '.25em', fontSize: '0.7em'}}>
    <em>The ball’s x- and y-coordinates specify its center. This is the right design decision.bounding box.</em>
  </p>
</div>
</Slide>

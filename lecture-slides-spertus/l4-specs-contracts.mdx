...
## What's your progress on Assignment 1? (anonymous)
  <PollSlide
    image="/img/lectures/web/l5-work-completed.png"
    username="espertus"
  />
</Slide>
...
A small plaque or banner at the bottom with: 'Hyrum's Law: With enough users, all observable behaviors will be depended on—even the ones the spec never promised.'

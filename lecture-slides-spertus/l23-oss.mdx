...
<PollSlide
  question="Have you had a chance to look at Assignment 5?"
  answers={[
    'Not yet',
    "I've glanced at it",
...
The ISP says to split things used by different clients.

What's the difference?
</div>
<div className='fragment'>
Different clients used by a patron could be:
...
constrained to prioritize the Actor service boundary heuristic and to apply at
least one other heuristic.
</div>
<div className='fragment'>

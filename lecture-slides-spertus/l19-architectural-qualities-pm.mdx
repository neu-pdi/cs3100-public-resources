---
sidebar_position: 19
title: "Architectural Styles: From Hexagons to Monoliths (PM)"
...
New policy: I'm leaving the poll open for students who arrive late (but they
must still be in the room (or attending remotely by invitation) to complete it).
...
- [Complete the Survey](https://docs.google.com/forms/d/e/1FAIpQLScP-pp6S2tP4Do1J5buWmFLDDHwO5r8dxAmjZCB5wH20UDDiQ/viewform): choose students in either Oakland section
...
<Img src="/img/lectures/web/l19-facade-illustration.jpg"
  prompt="A side-by-side cutaway illustration. Left: a college classroom where a middle-aged female professor with curly brown hair and glasses presses a wall button. A projector screen displays 'FACADE' to seated students. Wires run from the button through a brick dividing wall. Right: a cramped utility room containing a complex Rube Goldberg machine powering the screen, featuring pulleys, a mechanical kicking boot, a hamster wheel, and a toy steam train on tracks. Warm, colorful cartoon style."
  alt="A side-by-side cutaway illustration. On the left, a professor in a college classroom presses a simple wall button. The projector screen lowers, displaying the word 'FACADE' to her students. Wires connect the button through a brick wall to a hidden utility room on the right. This room contains a chaotic Rube Goldberg machine powering the screen, featuring a hamster running on a wheel, a toy train on tracks, pulleys, and a mechanical kicking boot, illustrating a complex backend hidden behind a simple user interface."
  />
<aside className="notes">
...
<aside className="notes">
→ **Transition:** Let's see some architectural styles
</aside>
</Slide>
...
<div style={{display: 'flex', gap: '2rem', marginTop: '0.6em', alignItems: 'flex-start'}}>

<div style={{flex: 1}}>

**Deployment Topology**
<p style={{fontSize: '0.6em', fontStyle: 'italic', color: '#666', margin: '0.2em 0 0.6em'}}>Mutually exclusive — pick one</p>

<div style={{fontSize: '0.75em', display: 'flex', flexDirection: 'column', gap: '0.4em'}}>
  <div style={{border: '2px solid #6366F1', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Monolith</strong><br/>
    <span style={{color: '#555'}}>Single deployment unit, shared memory &amp; database</span>
  </div>
  <div style={{border: '2px solid #6366F1', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Modular Monolith</strong><br/>
    <span style={{color: '#555'}}>Single unit with enforced internal module boundaries</span>
  </div>
  <div style={{border: '2px solid #6366F1', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Microservices</strong><br/>
    <span style={{color: '#555'}}>Multiple independent services, network communication</span>
  </div>
</div>

</div>

<div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', fontSize: '2em', color: '#aaa', padding: '0 0.5em', marginTop: '1.5em'}}>+</div>

<div style={{flex: 1}}>

**Internal Code Organization**
<p style={{fontSize: '0.6em', fontStyle: 'italic', color: '#666', margin: '0.2em 0 0.6em'}}>Choose one, or combine</p>

<div style={{fontSize: '0.75em', display: 'flex', flexDirection: 'column', gap: '0.4em'}}>
  <div style={{border: '2px solid #0D9488', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Hexagonal</strong><br/>
    <span style={{color: '#555'}}>Domain at center, ports &amp; adapters at edges</span>
  </div>
  <div style={{border: '2px solid #0D9488', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Layered</strong><br/>
    <span style={{color: '#555'}}>Horizontal strata, dependencies flow downward</span>
  </div>
  <div style={{border: '2px solid #0D9488', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Pipelined</strong><br/>
    <span style={{color: '#555'}}>Sequential, composable processing stages</span>
  </div>
</div>
...
<p style={{fontSize: '0.65em', fontWeight: 'bold', textAlign: 'center', margin: '0.8em 0 0.4em'}}>Network Topology</p>
<p style={{fontSize: '0.6em', fontStyle: 'italic', color: '#666', margin: '0.2em 0 0.6em', textAlign: 'center'}}>Mutually exclusive — pick one</p>
<div style={{fontSize: '0.75em', display: 'flex', gap: '0.4em'}}>
  <div style={{flex: 1, border: '2px solid #6366F1', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Local</strong><br/>
    <span style={{color: '#555'}}>Single process, method calls</span>
  </div>
  <div style={{flex: 1, border: '2px solid #6366F1', borderRadius: '6px', padding: '0.5em 0.8em', textAlign: 'left'}}>
    <strong>Distributed</strong><br/>
    <span style={{color: '#555'}}>Multiple processes, HTTP / network</span>
  </div>
</div>
...
<p style={{fontSize: '0.82em'}}>
A <strong>modular monolith</strong> keeps the simplicity of a single deployment but adds <strong>enforced internal boundaries</strong>. 
</p>
...
<div className="fragment" style={{display: 'flex', gap: '1em', fontSize: '0.65em', marginTop: '0.5em'}}>

<div style={{flex: 1, padding: '0.5em', border: '2px solid #4CAF50', borderRadius: '6px', textAlign: 'center'}}>
...
<div style={{display: 'flex', flexDirection: 'column', gap: '0.75em', fontSize: '0.58em', marginTop: '0.75em'}}>

<div className="fragment" style={{padding: '0.75em', border: '2px solid #FF9800', borderRadius: '8px'}}>
...
<p style={{marginBottom: '0.5em', color: '#9370DB'}}>**How the system is deployed**</p>
...
<p style={{marginBottom: '0.5em', color: '#4CAF50'}}>**How code is internally organized**</p>
...
<strong>The key rule:</strong> dependencies flow <strong>downward</strong>. In other words, each layer holds a reference only to the layer beneath it.
</p>

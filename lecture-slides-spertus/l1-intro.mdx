...
## What's your experience with AI coding?
  <PollSlide
    image="/img/lectures/ellen/common/pollev-smiles.png"
    username="espertus"
  />
</Slide>
...
## Java compilation/execution
  ...
  <ImageSlide
    imageSrc="/img/lectures/ellen/l1-java-bytecode.svg"
    imageHeight = '60vh'
  />
...
<div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5em', fontSize: '0.85em'}}>
  <div>
    ...
    <ul style={{marginTop: '0.3em'}}>
      ...
      <li>`int` max ≈ 2 billion ($2^{31} - 1$)</li>
    </ul>
  </div>
  <div>
...
<ImageSlide
  imageSrc="/img/lectures/ellen/l1-pawtograder-flashcards.png"
    imageAlt="Screenshot showing flashcard access in Pawtograder"
    imageHeight='50vh'
  />
...
- Optionally, complete the lecture 1 Java flashcards
...
*Any questions? Ask on Pawtograder.*

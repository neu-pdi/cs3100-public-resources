...
## Poll: What quality attributes can you think of for usability?

<div style={{ fontSize: '.8em' }}>
Software quality attributes were:
* simplicity, modularity, testability
* maintainability, changeability, deployability
* scalability, responsiveness, reliability/fault tolerance
</div>
...
- <span style={{color: 'green'}}>✓</span> High: See "Living Room" → tap → adjust
- <span style={{color: 'red'}}>✗</span>Low: See "Area Hierarchy Browser" → confused

</div>

<div className='fragment' style={{backgroundColor: 'rgba(73,154,170,0.15)', padding: '0.8em', borderRadius: '8px'}}>
...
## OS Example: Renaming a File
<div style={{ fontSize: '.8em' }}>
How to change the name of a file from `old-name.txt` to `new-name.txt`?
</div>

<div style={{display: 'flex', alignItems: 'center', gap: '2rem'}}>

<div className='fragment' style={{flex: 2, fontSize: '.6em' }}>
...
<div className='fragment'>
<Img src="/img/lectures/web/l24-rename-file-gui1.png" alt="File rename dialog in Windows Explorer showing the Rename option in the context menu" />
</div>

<div className='fragment'>
<Img src="/img/lectures/web/l24-rename-file-gui2.png" alt="File rename dialog in Windows Explorer showing editable file name field" />
</div>
</div>
...
<p style={{fontSize: '0.8em'}}><br/>
*"Would Marcus find this useful? Would Dorothy be confused?"*
</p>

<Img
  src="/img/lectures/web/l24-personas-cropped.png"
  width={665}
...
<p style={{fontSize: '0.7em', marginTop: '0em', color: '#9370DB'}}>
Features Marcus loves (automations, shortcuts) overwhelm Dorothy.<br/>
...
<p style={{fontSize: '0.7em', marginTop: '1em', fontWeight: 'bold', color: '#9370DB'}}>
...
**Strategy 3 is best:**
- Defaults match common expectations, but interface always shows what's actually happening

→ When mental models are wrong, it's not just annoying — it can be dangerous...
</aside>
...
**There are different safety categories:**
...
## Human Error Has a Taxonomy: James Reason's Classification
...
<aside className="notes">
***Definitions***
A **slip** is a mistaken **action**.
  * intrusion → unwanted action (maybe by habit)
  * rest are obvious from names
A **lapse** is internal, such as not remembering something.
...
## Unsafe Intended Actions

<Img src='/img/lectures/web/l24-unsafe-intended-actions.jpg'
  alt="Subset of diagram from previous slide focused on unsafe acts. An oval labeled Unsafe Acts points to a box labeled Intended Action, which branches into two paths: Mistake, which leads to rule-based mistakes (misapplication of good rule, application of bad rule) and knowledge-based mistakes (many variable forms); and Violation, which leads to routine violations, exceptional violations, and acts of sabotage."
/>
<div style={{ fontSize: '.7em' }}>
* Rule-based mistakes
  * Misapplication of good rule: Turns off all lights when all family members leave [but there could be houseguests]
  * Application of bad rule: Turns on lights in room if motion detected [but could wake a restless sleeper]
  * Knowledge based mistake: Doesn't realize "turn off wi-fi" disables appliance scheduling
* Violations
  * Routine violation: Habitually disables motion sensor at night instead of setting up night mode
  * Exceptional violation: During a power outage, props door open for easy entry/exit
  * Acts of sabotage: Ex-roommate disables locks
</div>
<aside className="notes">
...
<span style={{color: 'green'}}>✓</span> Gold standard — direct evidence

<span style={{color: 'red'}}>✗</span> Expensive, time-consuming
...
<span style={{color: 'green'}}>✓</span> Large samples, real context

<span style={{color: 'red'}}>✗</span> Happens late in the process

<span style={{color: 'red'}}>✗</span> Self-reported, no observation
...
<span style={{color: 'green'}}>✓</span> Fast, cheap, works on prototypes

<span style={{color: 'red'}}>✗</span> May miss domain-specific issues
...
## H2: Match Between the System and the Real World (Stove)

<Img
  src="/img/lectures/web/l24-burner-controls.jpg"
  alt="Two gas stovetops viewed from above. The left has four burners with controls in a straight horizontal row, making it unclear which knob controls which burner. The right (GE Profile) arranges five knobs to spatially correspond to burner positions, making the mapping intuitive."
/>
<br/><br/><br/>
<div style={{ fontSize: '.6em' }}>
Source: [Nielsen/Norman Group](https://www.nngroup.com/articles/natural-mappings/)
</div>
...
<Img src='/img/lectures/web/l24-dilbert-user-interface.jpg'
  alt="Dilbert comic strip. Panel 1: manager says 'Customers are complaining because our user interface is confusing.' Panel 2: developer says 'For example, our menu choice for deleting a file is labeled Save File.' Panel 3: manager says 'That is why we have a help menu.' Developer responds 'Our help menu is labeled Reformat Hard Drive.'"
/>

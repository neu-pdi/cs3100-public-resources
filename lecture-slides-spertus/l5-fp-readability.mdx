...
**The "late arrival" narrative:**
- Java was 40 years late to functional programming
- Haskell, ML, Lisp had this in the 70s-80s
- Scala (2004), Kotlin (2016), even C# (2020) beat Java
- But better late than never—Java developers finally have these tools

**Key message:** Today we learn what Java developers in 2010 wished they had. The good news: now we have it.
...
<PollSlide
  choices={["Python", "Java", "I like them equally", "I don't know Java well enough yet to have an opinion"]}
  username="espertus"
/>
...
<PollSlide username="espertus" bottomText="Remember to state the language." />
...
<p style={{fontSize: '0.85em', marginTop: '1em', color: '#e74c3c'}}>
  <strong>The bus factor:</strong> If code is only readable to its author, the project is at risk.
</p>

<aside className="notes">
**The bus factor:**
- "What happens if the author gets hit by a bus?"
- Or more positively: "takes a bus to a new job"
...
<ol style={{fontSize: '0.9em'}}>
  <li><strong>Lambdas (Java 8, 2014):</strong> Express behavior without boilerplate classes</li>
  <li><strong>Records and Pattern Matching (Java 16, 2021):</strong> Define data classes without boilerplate methods</li>
  <li><strong>Good naming:</strong> Make intent clear even when syntax is perfect</li>
</ol>

{/* I'm removing this because I don't want to keep saying how sucky Java is. --ES
<p style={{fontSize: '0.8em', marginTop: '1em', color: '#888'}}>
  (Haskell had all of this in 1990. Scala in 2004. Kotlin in 2016.)
</p>
...
2. Records and Pattern Matching — for data (eliminating boilerplate)
3. Naming — for everything (the foundation)

**The historical aside:**
- Yes, other languages have had this for decades
- Java developers weren't writing verbose code because it was BETTER
- They were doing it because Java hadn't caught up yet
- Now it has—let's learn to use what we've got
...
<Img src="/img/lectures/web/l5-hard-things-in-cs"
alt="T-shirt reading: 'There are two hard things in Computer Science: cache invalidation, naming things, and off-by-one errors"/>

<aside className="notes">
* Many of the slides describe these 4 things as 3 things
</aside>
</Slide>
...
**Historical context:**
- This is "functional programming 101"
- Lisp had this in 1958—66 years ago
- Haskell, ML, Scheme: functions as values from day one
- Java resisted this for 18 years (1996-2014)

**Why Java was late:**
- Java's designers wanted "simplicity"
- Everything had to be an object
- So they made you create objects to hold functions
- Anonymous inner classes: the workaround

**Java's approach:**
- Functions ARE objects (functional interfaces)
- But lambdas hide the object creation
- You write behavior, Java wraps it

→ **Transition:** Java 8 finally made this possible...
</aside>
...
## Java 8 (2014): 18 Years Late to the Party

<p style={{fontSize: '0.85em'}}>
  Before Java 8, storing "behavior" required creating an object:
</p>

```java
// Before Java 8: Create an object that holds the behavior
...
<p style={{fontSize: '0.85em', marginTop: '0.5em'}}>
  Java 8 (2014) <em>finally</em> added <strong>lambda expressions</strong>:
</p>

```java
// After Java 8: Just write the behavior
Comparator<Light> comp = (l1, l2) ->
    Integer.compare(l1.getBrightness(), l2.getBrightness());
```

<p style={{fontSize: '0.75em', marginTop: '0.5em', color: '#888'}}>
  (Lisp had this in 1958. Haskell in 1990. JavaScript in 1995. Java... 2014.)
</p>

<aside className="notes">
**Historical context:**
- Java launched in 1996 without lambdas
- For 18 YEARS, Java developers wrote anonymous inner classes
- Every other major language had lambdas long before
- Java 8 was finally "admitted to the club"

**The cost of being late:**
- Millions of lines of verbose Comparator code
- Entire frameworks (Guava) built to work around the limitation
- A generation of developers who never learned functional style

**But now:**
- Java has lambdas
- We can write what Scala developers wrote in 2004
...
## Records (Java 16, 2021) {/*: 17 Years After Scala */}
...
<p style={{fontSize: '0.75em', marginTop: '0.5em', color: '#888'}}>
  Scala had <code>case class Point(x: Int, y: Int)</code> in 2004.<br/>
  Kotlin had <code>data class Point(val x: Int, val y: Int)</code> in 2016.<br/>
  Even C# got records in 2020—before Java.
</p>
*/}
<aside className="notes">
**The lateness:**
- Scala: case classes since 2004
- Kotlin: data classes since 2016
- C#: records in 2020
- Java: records in 2021 (!)
- Java was LAST among major languages

**What Java developers did for 25 years:**
- Wrote 30 lines for every simple data class
- Used Lombok (a code generation hack)
- Envied Kotlin developers

**But now:**
- Records work
- They're idiomatic Java
- Use them for data classes
...
<aside className="notes">
**More lateness:**
- Haskell: pattern matching since 1990
- ML: pattern matching since 1973 (!)
- Scala, Rust, Kotlin: all had it before Java
- Java 16 (2021): finally arrives

**The Java pattern:**
- Check type, then cast, then use
- Three steps for one concept
- Easy to forget the cast, get ClassCastException

**Now:**
- One step: `instanceof DimmableLight light`
- Scoped correctly
- Use it everywhere
...
## Summary: Java Finally Caught Up—Now Use It

<ol style={{fontSize: '0.75em'}}>
  <li><strong>Readability is the goal</strong> — code is read far more than written</li>
  <li><strong>Functions as objects</strong> — the breakthrough that took Java 18 years to adopt</li>
  <li><strong>Lambdas reveal intent</strong> — what Haskell had in 1990, Java got in 2014</li>
  <li><strong>Records eliminate boilerplate</strong> — what Scala had in 2004, Java got in 2021</li>
  <li><strong>Pattern matching reduces ceremony</strong> — what ML had in 1973, Java got in 2021</li>
...
<p style={{fontSize: '0.85em', marginTop: '0.5em', color: '#9370DB'}}>
  Better late than never. The tools are here. <strong>Use them.</strong>
</p>

<aside className="notes">
**Key takeaways:**
- Java was decades late to these features
- That era is over—we have the tools now
...
**The privilege:**
- Students today learn Java WITH these features
- Previous generations had to write the verbose versions
- You're learning the modern way from the start

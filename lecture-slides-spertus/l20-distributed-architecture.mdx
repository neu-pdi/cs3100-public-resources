...
## Poll: How much more expensive is reading from disk rather than memory?
...
<div style={{padding: '0.6em',fontSize: '0.8em', border: '2px solid #9370DB', borderRadius: '8px'}}>
...
<div className="fragment">
<p style={{fontSize: '0.75em', marginTop: '0.75em', fontStyle: 'italic', color: '#666'}}>
Trivia: Anyone know what the code for "unavailable for legal reasons"?
</p>
</div>

<aside className="notes">
- View status code if a request failed
...
while (response == null && attempts < 3) {
  try {
    ...
    // This performs xponential backoff: 1s, 2s, 4s
...
<p style={{fontSize: '0.72em'}}>
<em>Thia pattern addresses Fallacy 1 (unreliable). Never wait forever — set a deadline, then try again, backing off between attempts.</em>
</p>

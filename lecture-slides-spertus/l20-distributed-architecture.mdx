...
<Img src='/img/lectures/web/l20-orkut-team.jpg'
  alt='A group of 8 smiling people sitting around a Google cafeteria table'
  width={1000}
/>
</Slide>
...
## REST is Built on a Layered Architecture
...
<aside className="notes">
- All REST needs to do is use HTTP
- The layering protects it from lower-down details
</aside>
...
<div className='fragment' style={{padding: '0.6em', border: '2px solid #4A90A4', borderRadius: '8px'}}>

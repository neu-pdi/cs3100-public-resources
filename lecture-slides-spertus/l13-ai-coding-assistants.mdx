...
<ul style={{fontSize: '0.8em'}}>
  <li><strong>Lab 6 (Tuesday):</strong> Hands-on practice + surveys that will shape future lectures and workshops</li>
  <li><strong>Rest of semester:</strong> AI will be woven throughout our remaining lectures and assignments—this conversation continues</li>
</ul>

<p style={{fontSize: '0.85em', marginTop: '1em', fontStyle: 'italic'}}>
...
* File a [Final Exam Conflict form](https://northeastern.service-now.com/registrar?id=sc_cat_item&sys_id=8a915d2f97cf0e50beddb4221153afd9&sysparm_category=07325e0197487110beddb4221153afb7) if you have two finals scheduled at the same time. (You can also file the form if you have more than 2 finals on the same day.)
...
* See also [Final Examinations and Related Policies on Other Exams and Final Term Papers/Projects](https://catalog.northeastern.edu/undergraduate/academic-policies-procedures/final-examinations-related-policies-final-papers-projects/).
...
<div style={{fontSize: '0.85em',}}>
* We can tell that some students are using AI-generated code _without
  documenting it_. There's no penalty!
...
<Img src="/img/lectures/web/l13-remember-who-you-are.webp"
  alt="A note card reading: 'Remember who you are and what you represent. -- Hettie Belle Ege, Mills College, Est. 1852"
/>

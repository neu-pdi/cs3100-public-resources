...
:::note Recall
In [Lecture 21 (Serverless Architecture)](/lecture-notes/l21-serverless), we encountered caching and asked: "What happens when multiple sources of truth diverge? When should the cache refresh?" Those were consistency questions. Now we formalize the concept of consistency models and learn how to choose the right one for different requirements.
:::
